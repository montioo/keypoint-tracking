...
# ---
# Builds the keypoint dataset.
#
# This script was developed by Wei Gao and Lucas Manuelli in https://github.com/weigao95/mankey-ros
...
from mankey.utils.utility import quat_to_rot_mat
...
def camera2world_from_map(camera2world_map) -> np.ndarray:
    ...
    camera2world_matrix = quat_to_rot_mat(camera2world_quat)
